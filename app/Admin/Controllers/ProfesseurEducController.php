...
class ProfesseurEducController extends AdminController
{
    protected $title = 'Mes Classes et Professeurs';
    ...
    protected function grid()
    {
        ...
        // ID des Professeurs
        $grid->column('professeurs_ids', __('ID'))->display(function () {
            ...
            foreach ($affectations as $aff) {
                ...
                $id = optional($prof)->id ?? optional($prof)->id_professeurs ?? $aff->professeurs_id ?? 'N/A';
