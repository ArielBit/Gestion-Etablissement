...
@section('title', 'Succès Paiement Donateur | '. $etablissement->etablissement->nom)
...
<section class="space-top space-bottom" style="background-color: #0b0d12; min-height: 75vh; display: flex; align-items: center;">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
               ...
               <div class="success-icon-wrap mb-40 wow fadeInUp" data-wow-delay=".1s">
                ...
                <div class="title-area text-center mb-40 wow fadeInUp" data-wow-delay=".2s">
    <span class="sub-title" style="color: #31d807; letter-spacing: 2px;">Merci pour votre générosité</span>
    ...
    <p class="text-white-50 mt-3" style="margin: 0 auto;">Votre contribution soutient activement nos projets et nos apprenants.</p>
</div>
                <div class="btn-group-wrap d-flex flex-column align-items-center gap-3 wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-3 mt-2">
                        <a href="{{ route('donnateur') }}" class="th-btn btn-border style-radius" style="min-width: 240px; background: transparent; border: 2px solid rgba(255,255,255,0.2); color: #fff;">
                            <i class="fas fa-hand-holding-heart me-2"></i> Faire un autre don
                        </a>
